...
exports.bindResize = exports.bindViewSize = function(self) {
  ...
  self.__didMount = lookup(self, 'componentDidMount');
  self.__willUnmount = lookup(self, 'componentWillUnmount');
...
exports.lookupMethod = lookup;
function lookup(ctx, funcname) {
  while(ctx) {
    if (typeof ctx[funcname] == 'function') return ctx[funcname];
